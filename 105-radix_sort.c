...
#include "sort.h"
/**
 * csort2 - auxiliary func of radix sort
 *
 * @array: array of data to be sorted
 * @buff: malloc buffer
 * @size: volume of data
 * @lsd: Low significant digit
 *
 * Return: void
 */
...
/**
 * csort - auxiliary func of radix sort
 *
 * @array: array of data to be sorted
 * @size: volume of data
 * @lsd: Low significant digit
...
/**
 * radix_sort - sorts an array of int in highest order using the Radix
 * sort algorithm
 *
 * @array: array of data to be sorted
 * @size: volume of data
